...
import { BODY_METRICS, type BodyMetric } from '../lib'

interface BodyMetricSelectorModalProps {
	visible: boolean
	selectedMetric: BodyMetric
	onSelect: (metric: BodyMetric) => void
	onClose: () => void
}

export const BodyMetricSelectorModal = ({
	visible,
	selectedMetric,
	onSelect,
	onClose,
}: BodyMetricSelectorModalProps) => {
	const handleSelect = (metric: BodyMetric) => {
		onSelect(metric)
		onClose()
	}
