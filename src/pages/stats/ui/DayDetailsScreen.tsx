                ...
                <View className="mt-2 flex-row items-center gap-4">
                    {task.duration ? (
                        <View className="flex-row items-center gap-1">
                            ...
                            <Text className="text-light-text-300 text-t3">
                                {task.duration} минут
                            </Text>
                        </View>
                    ) : null}
    ...
    return (
        <View className="flex-1 bg-black">
            <LinearGradient
                ...
                style={{ paddingTop: 48, paddingHorizontal: 20, paddingBottom: 28, borderBottomLeftRadius: 26, borderBottomRightRadius: 26 }}
            >
                <TouchableOpacity
                    onPress={() => router.back()}
                    activeOpacity={0.8}
                ...
                <Text className="mt-1 text-body-medium text-light-text-300">
                    Активности за день
                </Text>
            </LinearGradient>
            ...
            >
                {isLoading ? (
                    <View className="mt-8 items-center">
                        ...
                        <Text className="mt-3 text-body-medium text-light-text-300">
                    ...
                    <View className="mt-8 rounded-3xl bg-[#1f1f1f] p-5">
                        <Text className="text-center text-body-medium text-light-text-200">
