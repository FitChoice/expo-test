...
export const getInputStyles = (
  ...
  if (size === 'settings') {
    ...
    inputClasses += 'rounded-2xl px-3 py-2.5 min-h-[44px] sm:px-4 sm:py-3 sm:min-h-[48px] '; // 16px, адаптивный padding
  }
  ...
  if (size === 'default') {
    if (disabled) {
      ...
      // Focused state
      inputClasses += 'bg-fill-800 border border-brand-purple-500 shadow-[0px_0px_5px_0px_rgba(187,162,254,0.8)] ';
    } else {
      // Default state
